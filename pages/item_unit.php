                          ...
                          if(temp["status"]=='success'){
                            if( (temp["form"]=='ShowItem') ){
                              ...
                              for (var i = 0; i < (Object.keys(temp).length-2); i++) {
                                 ...
                                 var chkDoc = "<label class='container'style='margin-top: 20%;'><input type='radio' name='checkitem' id='checkitem_"+i+"'  style='margin-top: 24%;' value='"+temp[i]['UnitCode']+"' onclick='getdetail(\""+temp[i]["UnitCode"]+"\",\""+i+"\")'><span class='checkmark'></span></label>";
                                 ...
                                 StrTR = "<tr id='tr"+temp[i]['UnitCode']+"'>"+
                                                "<td style='width: 5%;'>"+chkDoc+"</td>"+
                                                "<td style='width: 10%;'>"+(i+1)+"</td>"+
                                                "<td style='width: 15%;'>"+temp[i]['UnitCode']+"</td>"+
                                                "<td style='width: 70%;'>"+temp[i]['UnitName']+"</td>"+
                                                "</tr>";
