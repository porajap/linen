                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class='form-group row'>
                                      ...
                                      <input class="form-control col-sm-8" autocomplete="off" style="font-size:22px;"  id='RefDocNo' placeholder="<?php echo $array['refdocno'][$language]; ?>" onclick="open_claim_doc()">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class='form-group row'>
