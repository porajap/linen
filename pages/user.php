                    ...
                    if (temp["status"] == 'success') {
                        if ((temp["form"] == 'ShowItem')) {
                            ...
                            for (var i = 0; i < (Object.keys(temp).length - 2); i++) {
                                ...
                                var chkDoc = "<label class='container'><input type='radio' name='checkitem' id='checkitem_"+i+"' style='margin-top: 24%;' value='" + temp[i]['ID'] + "' onclick='getdetail(\"" + temp[i]["ID"] + "\",\""+i+"\")'><span class='checkmark'></span></label>";
