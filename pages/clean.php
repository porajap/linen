                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class='form-group row'>
                                      ...
                                      <input class="form-control col-sm-8 only" style="font-size:22px;"  autocomplete="off" id='RefDocNo' placeholder="<?php echo $array['refdocno'][$language]; ?>" onclick="open_dirty_doc()">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class='form-group row'>
