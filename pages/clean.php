            ...
            if(temp["status"]=='success'){
              if(temp["form"]=='OnLoadPage'){
                ...
                for (var i = 0; i < temp["Row"]; i++) {
                  ...
                  var Weight = "<div class='row' style='margin-left:2px;'><input class='form-control' style='height:40px;width:110px; margin-left:3px; margin-right:3px; text-align:center;;font-family:THSarabunNew;' id='iweight"+i+"' placeholder='0'></div>";
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class='form-group row'>
                                      ...
                                      <input class="form-control col-sm-8" autocomplete="off" id='RefDocNo' placeholder="<?php echo $array['refdocno'][$language]; ?>" onclick="open_dirty_doc()">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class='form-group row'>
                          ...
                          <div class="col-md-6 mhee">
                            <div class="row" style="margin-left:2px;">
                              ...
                              <div class="search_custom col-md-3">
                                          ...
                                          </div>                            <!-- <button type="button" style="margin-left:10px;" class="btn btn-primary" name="button" onclick="ShowDocument(1);"><?php echo $array['search'][$language]; ?></button> -->
                                          <div class="search_custom col-md-3">
                                            <div class="d-flex justify-content-start">
                                              <div class="circle2 d-flex align-items-center d-flex justify-content-center">
                                          ...
                                          </div>                            <!-- <button type="button" style="margin-left:10px;" class="btn btn-primary" name="button" onclick="ShowDocument(2);"><?php echo $array['searchalldep'][$language]; ?></button> -->
                          </div>
                        </div>
