                          ...
                          if(temp["status"]=='success'){
                            if( (temp["form"]=='ShowItem') ){
                              ...
                              for (var i = 0; i < (Object.keys(temp).length-2); i++) {
                                 ...
                                 var chkDoc = "<label class='container'style='margin-top: 20%;'><input type='radio' name='checkitem' class='check1' id='checkitem_"+i+"'  style='margin-top: 24%;'value='"+temp[i]['CategoryCode']+"' onclick='getdetail(\""+temp[i]["CategoryCode"]+"\",\""+i+"\")'><span class='checkmark'></span></label>";
