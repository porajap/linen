                          ...
                          if(temp["status"]=='success'){
                            if( (temp["form"]=='ShowItem') ){
                              ...
                              for (var i = 0; i < (Object.keys(temp).length-2); i++) {
                                 ...
                                 var chkDoc = "<label class='container'><input type='radio' name='checkitem' id='checkitem_"+i+"' value='"+temp[i]['HptCode']+"' onclick='getdetail(\""+temp[i]["HptCode"]+"\" , \""+i+"\")'><span class='checkmark'></span></label>";
