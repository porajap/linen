...
<html lang="en">
  ...
  <head>
    ...
    <title><?php echo $array['hostpital'][$language]; ?></title>
                          ...
                          if(temp["status"]=='success'){
                            if( (temp["form"]=='ShowItem') ){
                              ...
                              for (var i = 0; i < (Object.keys(temp).length-2); i++) {
                                 ...
                                 var chkDoc = "<label class='container'style='margin-top: 20%;'><input type='radio' name='checkitem' id='checkitem_"+i+"' value='"+temp[i]['HptCode']+"' onclick='getdetail(\""+temp[i]["HptCode"]+"\" , \""+i+"\")'><span class='checkmark'></span></label>";
