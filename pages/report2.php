...
<!-- --------------------------------date------------------------------------------------- -->
                      ...
                      <div class="col-md-6">
                        <div class='form-group row'>
                            ...
                            <input type="text" autocomplete="off" style="font-size:22px;" class="form-control col-sm-8 datepicker-here numonly charonly" id="datepicker1" data-language=<?php echo $language ?>  data-date-format='dd-mm-yyyy' >
                          </div>
                        </div>
                          ...
                          <input type="text" autocomplete="off" style="font-size:22px;" class="form-control col-sm-8 datepicker-here numonly charonly" id="datepicker2" data-language=<?php echo $language ?> data-date-format='dd-mm-yyyy' >
													</div>
												</div>
											</div> -->
<!-- --------------------------------end------------------------------------------------- -->
...
<!-- --------------------------------จุดเก็บเงิน------------------------------------------------- -->
											<div class="row">
												<div class="col-md-6">
													<div class='form-group row checkblank'>
														<label class="col-sm-4 col-form-label text-right">รหัสจุดเก็บเงิน/จุดเก็บเงิน</label>
														<select class="form-control col-sm-7" id="" style="font-size:22px;" onchange="departmentWhere();"></select>
													</div>
												</div>
												<div class="col-md-6">
													<div class='form-group row checkblank'>
														<label class="col-sm-4 col-form-label text-right">เลขที่ใบเสร็จรับเงิน</label>
                            <input type="text" autocomplete="off" style="font-size:22px;" class="form-control col-sm-7" name="searchitem" id="" placeholder="เลขที่ใบเสร็จรับเงิน">
													</div>
												</div>				
											</div>
<!-- --------------------------------end------------------------------------------------- -->		
<!-- --------------------------------เลขที่ใบเสร็จ------------------------------------------------- -->
                        ...
                        <div class="col-md-6">
													<div class='form-group row checkblank'>
														<label class="col-sm-4 col-form-label text-right">เลขที่ใบนำส่งเงิน</label>
                            <input type="text" autocomplete="off" style="font-size:22px;" class="form-control col-sm-7" name="searchitem" id="" placeholder="เลขที่ใบนำส่งเงิน">
													</div>
												</div>
                        <div class="col-md-6">
													<div class='form-group row checkblank'>
														<label class="col-sm-4 col-form-label text-right">เลขที่ใบสั่งซื้อสินค้า</label>
                            <input type="text" autocomplete="off" style="font-size:22px;" class="form-control col-sm-7" name="searchitem" id="" placeholder="เลขที่ใบสั่งซื้อสินค้า">
													</div>
												</div>
											</div>
...
<!-- --------------------------------ใบสั่งซื้อสินค้า------------------------------------------------- -->									
                      <div class="row" >
                        <div class="col-md-6">
													<div class='form-group row checkblank'>
														<label class="col-sm-4 col-form-label text-right">ชื่อผู้ที่รับเงิน</label>
                            <input type="text" autocomplete="off" style="font-size:22px;" class="form-control col-sm-7" name="searchitem" id="" placeholder="ชื่อผู้ที่รับเงิน">
													</div>
												</div>
												<div class="col-md-6">
													<div class='form-group row checkblank'>
														<label class="col-sm-4 col-form-label text-right">การชำระเงิน/ส่วนลด</label>
														<select class="form-control col-sm-7" id="" style="font-size:22px;" onchange="departmentWhere();"></select>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6 ">
													...
													<div class='form-group row' id="showyear">
														...
														<input type="text"  class="form-control col-sm-7 datepicker-here only" id="year" data-min-view="years" data-view="years" data-date-format="yyyy" data-language='<?php echo $language ?>'>
													</div>
												</div>
												<div class="col-md-6" id="myDay">
													<div class='form-group row'>
														<label class="col-sm-4 col-form-label text-right"><?php echo $array['choosedate'][$language]; ?></label>
														<input type="text"  class="form-control col-sm-7 datepicker-here only" data-language='<?php echo $language ?>' id="oneday" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo  date('d-m-Y'); ?>">
														<input type="text"  class="form-control col-sm-7 datepicker-here only" data-language='<?php echo $language ?>' data-range="true" data-multiple-dates-separator=" - " id="someday" data-date-format="dd/mm/yyyy">
													</div>
												</div>
												<div class="col-md-6" id="myMonth">
													<div class='form-group row'>
														<label class="col-sm-4 col-form-label text-right"><?php echo $array['month'][$language]; ?></label>
														<input type="text"  class="form-control col-sm-7 datepicker-here only" id="onemonth" data-min-view="months" data-view="months" data-date-format="MM/yyyy" data-language='<?php echo $language ?>'>
														<input type="text"  class="form-control col-sm-7 datepicker-here only" id="somemonth" data-min-view="months" data-view="months" data-date-format="MM/yyyy" data-language='<?php echo $language ?>' data-range="true" data-multiple-dates-separator=" - ">
													</div>
												</div>
											</div>
