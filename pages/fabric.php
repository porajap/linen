          ...
          <div class="container-fluid">
            <div class="card-body" style="padding:0px; margin-top:-12px;">
                  ...
                  <table class="table table-fixed table-condensed table-striped mt-3" id="tableDocument" width="100%" cellspacing="0" role="grid">
                    <thead id="theadsum" style="font-size:24px;">
                      <tr role="row" id='tr_1'>
                        ...
                        <th nowrap style="width:45%"><?php echo $array['fabric-name'][$language]; ?></th>
                      </tr>
                    </thead>
              ...
              <div class="row mt-4">
                <div class="col-md-6">
                  <div class='form-group row'>
                    <label class="col-sm-3 col-form-label "><?php echo $array['fabric-name'][$language]; ?>
                    </label>
          ...
          if (!$.isEmptyObject(ObjData)) {
            $.each(ObjData, function(key, value) {
              ...
              StrTR += "<tr style='border-radius: 15px 15px 15px 15px;margin-top: 6px;margin-bottom: 6px;'>" +
                ...
                "<td style='width:45%;'>" + value.name_Fabric + "</td>" +
                "</tr>";
            });
          }
