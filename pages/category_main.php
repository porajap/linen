                          ...
                          if(temp["status"]=='success'){
                            if( (temp["form"]=='ShowItem') ){
                              ...
                              for (var i = 0; i < (Object.keys(temp).length-2); i++) {
                                 ...
                                 var chkDoc = "<label class='container'style='margin-top: 20%;'><input type='radio' name='checkitem' id='checkitem_"+i+"'  style='margin-top: 24%;'class='check1' value='"+temp[i]['MainCategoryCode']+"' onclick='getdetail(\""+temp[i]["MainCategoryCode"]+"\",\""+i+"\")'><span class='checkmark'></span></label>";
                                ...
                                <div class="row mt-4">
                                  <div class="col-md-6">
                                    <div class='form-group row'>
                                      ...
                                      <input type="text"  class="form-control col-sm-8 " id="CategoryCode"    placeholder="<?php echo $array['categorycode'][$language]; ?>" disabled="true">
                                    </div>
                                  </div>
                                </div>  
   <!-- =================================================================== -->
