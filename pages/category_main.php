                          ...
                          if(temp["status"]=='success'){
                            if( (temp["form"]=='ShowItem') ){
                              ...
                              for (var i = 0; i < (Object.keys(temp).length-2); i++) {
                                 ...
                                 var chkDoc = "<label class='container'><input type='radio' name='checkitem' id='checkitem_"+i+"'  style='margin-top: 24%;'class='check1' value='"+temp[i]['MainCategoryCode']+"' onclick='getdetail(\""+temp[i]["MainCategoryCode"]+"\",\""+i+"\")'><span class='checkmark'></span></label>";
