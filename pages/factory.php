                          ...
                          if(temp["status"]=='success'){
                            if( (temp["form"]=='ShowItem') ){
                              ...
                              for (var i = 0; i < (Object.keys(temp).length-2); i++) {
                                 ...
                                 var chkDoc = "<label class='container'style='margin-top: 20%;'><input type='radio' name='checkitem' id='checkitem_"+i+"' value='"+temp[i]['FacCode']+"' onclick='getdetail(\""+temp[i]["FacCode"]+"\" , \""+i+"\")'><span class='checkmark'></span></label>";
