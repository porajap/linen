...
$Sql = "SELECT
        ...
        DATE_FORMAT(shelfcount.DvEndTime,'%H:%I:%S') AS ENDTIME
        FROM
        shelfcount
...
$pdf->Cell(10, 10, iconv("UTF-8", "TIS-620", $array2['no'][$language]), 1, 0, 'C');
$pdf->Cell(40, 10, iconv("UTF-8", "TIS-620", $array2['itemname'][$language]), 1, 0, 'C');
$pdf->Cell(20, 10, iconv("UTF-8", "TIS-620", $array2['parqty'][$language]), 1, 0, 'C');
$pdf->Cell(20, 10, iconv("UTF-8", "TIS-620", $array2['shelfcount1'][$language]), 1, 0, 'C');
$pdf->Cell(20, 10, iconv("UTF-8", "TIS-620", $array2['max'][$language]), 1, 0, 'C');
$pdf->Cell(20, 10, iconv("UTF-8", "TIS-620", $array2['issue'][$language]), 1, 0, 'C');
$pdf->Cell(20, 10, iconv("UTF-8", "TIS-620", $array2['short'][$language]), 1, 0, 'C');
$pdf->Cell(20, 10, iconv("UTF-8", "TIS-620", $array2['over'][$language]), 1, 0, 'C');
$pdf->Cell(20, 10, iconv("UTF-8", "TIS-620", $array2['weight'][$language]), 1, 1, 'C');
...
$issue=$Result['ParQty']-$Result['CcQty'];
  ...
  $pdf->Cell(20, 10, iconv("UTF-8", "TIS-620", $Result['OverPar']), 1, 0, 'C');
...
$pdf->Cell(5);
$pdf->Cell(110, 10, iconv("UTF-8", "TIS-620", $array2['sign'][$language]."...................................................".$array2['packing'][$language]), 0, 0, 'L');
$pdf->Cell(35, 10, iconv("UTF-8", "TIS-620", $array2['date'][$language]."........................................".$array2['time'][$language]."............................."), 0, 0, 'L');
$pdf->Ln(7);
$pdf->Cell(5);
$pdf->Cell(110, 10, iconv("UTF-8", "TIS-620", $array2['sign'][$language]."...................................................".$array2['passenger'][$language]), 0, 0, 'L');
$pdf->Cell(35, 10, iconv("UTF-8", "TIS-620", $array2['date'][$language]."........................................".$array2['time'][$language]."............................."), 0, 0, 'L');
$pdf->Ln(7);
$pdf->Cell(5);
$pdf->Cell(110, 10, iconv("UTF-8", "TIS-620", $array2['sign'][$language]."...................................................".$array2['receiver'][$language]), 0, 0, 'L');
$pdf->Cell(35, 10, iconv("UTF-8", "TIS-620", $array2['date'][$language]."........................................".$array2['time'][$language]."............................."), 0, 0, 'L');
$pdf->Ln(7);
$pdf->Ln(7);
$pdf->Cell(5);
