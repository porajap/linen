...
class PDF extends FPDF
{
  function Header()
  {
      ...
      // Page number
      $this->Cell(0, 10, iconv("UTF-8", "TIS-620", 'หน้าที่ ') . $this->PageNo() . '/{nb}', 0, 0, 'R');
  } 
...
$pdf->Cell(190, 10, iconv("UTF-8", "TIS-620", "คณะแพทยศาสตร์ศิริราชพยาบาล มหาวิทยลัยมหิดล"), 0, 0, 'C');
$pdf->Cell(190, 10, iconv("UTF-8", "TIS-620", "ใบนำส่งเงิน"), 0, 0, 'C');
// Line break
$pdf->Ln(10);

$pdf->SetFont('THSarabun', 'b', 16);
$pdf->Cell(95 , 10, iconv("UTF-8", "TIS-620", "ยาตำรับศิริราช"), 0, 0, 'C');
$pdf->Cell(95 , 10, iconv("UTF-8", "TIS-620", "เลขที่ใบนำส่ง           NM6200000000001"), 0, 0, 'C');
$pdf->Ln();
$pdf->Cell(95 , 10, iconv("UTF-8", "TIS-620", "รหัสจุดเก็บเงิน :    NM1"), 0, 0, 'C');
$pdf->Cell(95, 10, iconv("UTF-8", "TIS-620", "วันที่          1/27/2019"), 0, 0, 'C');
$pdf->Ln();
$pdf->Cell(95, 10, iconv("UTF-8", "TIS-620", "ชื่อจุดเก็บเงิน:      นวมินทร์"), 0, 0, 'C');
$pdf->Cell(95, 10, iconv("UTF-8", "TIS-620", "รอบเวลา       1/27/2019 09.30."), 0, 0, 'C');
$pdf->Ln(10);
