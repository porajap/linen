...
<body>
  ...
  <a style="width:9%;" class="current_page" href="pages/menu.php?lang=<?php echo $language; ?>" onclick="return loadIframe('ifrm', this.href)"><img src="img/7.png" style="width:70%;margin-top:55px;margin-bottom:20px;" alt=""></a>
    <!-- Navbar username -->
