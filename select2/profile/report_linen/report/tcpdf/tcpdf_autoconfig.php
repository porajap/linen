...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'cmu.jpg')) {
		$tcpdf_header_logo = 'cmu.jpg';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'รายละเอียดลงทะะเบียนเรียน');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by สถาบันกวดวิชา CMU Tutor");
}
